-- Скрипт для светящегося треугольника

print("=== Glowing Triangle Script Loaded ===")
...
function init()
    print("Инициализация светящегося треугольника")
    
    -- Устанавливаем начальные параметры (дальше от прямоугольника)
    setPosition(2.0, 1.5, 0)  -- Дальше вправо и выше от прямоугольника
    setRotation(0, 0, 0)
...
print("=== Glowing Triangle Script Ready ===")